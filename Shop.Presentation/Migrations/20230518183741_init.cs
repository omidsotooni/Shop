    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 5, 18, 22, 7, 40, 884, DateTimeKind.Local).AddTicks(8818), false, "Admin", null, null },
                    { 2L, new DateTime(2023, 5, 18, 22, 7, 40, 884, DateTimeKind.Local).AddTicks(8971), false, "Operator", null, null },
                    { 3L, new DateTime(2023, 5, 18, 22, 7, 40, 884, DateTimeKind.Local).AddTicks(8996), false, "Customer", null, null },
                    { 4L, new DateTime(2023, 5, 18, 22, 7, 40, 884, DateTimeKind.Local).AddTicks(9018), false, "Author", null, null }
                });
