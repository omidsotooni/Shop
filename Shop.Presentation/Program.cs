...
string postgreSqlConnectionString = @"Host=127.0.0.1;Port=5432;Database=ShopDB1;Username=postgres;Password=123456";
...
string hangfireConnectionString = @"Server=(localdb)\MSSQLLocalDB;Initial Catalog=HangfireDBTest1; Integrated Security=True;TrustServerCertificate=True";
